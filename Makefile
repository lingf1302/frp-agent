...
.PHONY: web web-ci frps-web frpc-web frps frpc agent-packages e2e-compatibility-smoke e2e-compatibility e2e-compatibility-floor
...
agent-packages:
	bash ./hack/build-agent-packages.sh
